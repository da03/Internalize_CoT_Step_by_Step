...
TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=0 stdbuf -oL -eL python src/train_mix_fixed.py \
    --model ${MODEL} \
    --from_pretrained /n/holyscratch01/rush_lab/Users/yuntian/cascade_jun12/train_models/mix_1_to_12_includingzero_padinput_d8_fixed_val16/gpt2/checkpoint_32 \
    --remove_start_from 264 \
    --start_epoch_from 33 \
    --data_folder ${FOLDER} \
    --epochs ${EPOCHS} \
    --lr ${LR} \
