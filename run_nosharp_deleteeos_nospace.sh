...
export SEED=1234
export SAVE=train_models/gsm8k_nosharp_deleteeos_nospace
mkdir -p $SAVE
PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=0 stdbuf -oL -eL python src/train_nosharp_deleteeos_nospace.py \
    --model ${MODEL} \
