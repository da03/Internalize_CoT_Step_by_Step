...
#export FOLDER=/n/rush_lab/Lab/Users/yuntian/implicit/data/long_mult_mixed_${NUM_DIGITS_MIN}_to_${NUM_DIGITS_MAX}_inter_mar1824_includingzero_padinput_short
export FOLDER=/n/holyscratch01/rush_lab/Users/yuntian/cascade_jun12/data/long_mult_mixed_${NUM_DIGITS_MIN}_to_${NUM_DIGITS_MAX}_inter_mar1824_includingzero_padinput_short
export MODEL=gpt2
export EPOCHS=200
export LR=5e-5
export BSZ=16
...
export SAVE=train_models/mix_${NUM_DIGITS_MIN}_to_${NUM_DIGITS_MAX}_includingzero_padinput_d${REMOVE_PER_EPOCH}_short_nosharp_deleteeos_eqn_val16_bsz16/gpt2
mkdir -p $SAVE
