    ...
    for epoch in range(args.epochs):
        ...
        if args.delete_beyond > 0 and to_delete_min < 10 and args.pretrain_epoch == 0:
            ...
            if accuracy > best_accuracy:
                print ('***best***')
                best_accuracy = accuracy
            accuracy, token_accuracy, ppl = evaluate(test_dataloader, tokenizer, ctx, teacher, args.max_new_tokens, to_delete_min, args.delete_side, args.delete_eos, args.lamb, probs, keep_position=args.keep_position, keep_allposition=args.keep_allposition, start_from=args.minus_start_from)
