...
@torch.no_grad()
# def evaluate(dataloader, tokenizer, device, ctx, model, max_new_tokens, pred_token_idx=0,  layer_names=None, cache_dir=None):
#     model.eval()
#     total_instances = 0
#     total_correct = 0
#     total_time = 0
...
#         activation_cache = ActivationCache(cache_dir, 100, pred_token_idx)
...
def main():
    ...
    parser.add_argument('--pred_token_idx', type=int, default=-1,
