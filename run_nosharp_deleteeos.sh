...
export SEED=1234
export SAVE=train_models/gsm8k_nosharp_deleteeos
mkdir -p $SAVE
TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=0 stdbuf -oL -eL python src/train_nosharp_deleteeos.py \
    --model ${MODEL} \
