...
export THOUGHT=5
export NUM_ZS=10
export FROM_PRETRAINED=train_models/countdown8/think5/gpt2/checkpoint_0
export ENTROPY_LOSS_LAMBDA=1.0
export SAVE=train_models/countdown8/zs_think${THOUGHT}_zs${NUM_ZS}_lamb${ENTROPY_LOSS_LAMBDA}/gpt2
mkdir -p $SAVE
...
export THOUGHT=5
export NUM_ZS=20
export FROM_PRETRAINED=train_models/countdown8/think5/gpt2/checkpoint_1
export ENTROPY_LOSS_LAMBDA=1.0
export SAVE=train_models/countdown8/zs_think${THOUGHT}_zs${NUM_ZS}_lamb${ENTROPY_LOSS_LAMBDA}/gpt2
mkdir -p $SAVE
...
export THOUGHT=5
export NUM_ZS=10
export FROM_PRETRAINED=train_models/countdown8/zs_think5_zs10_lamb1.0/gpt2/checkpoint_0
export ENTROPY_LOSS_LAMBDA=1.0
export SAVE=train_models/countdown8/zs_think${THOUGHT}_zs${NUM_ZS}_lamb${ENTROPY_LOSS_LAMBDA}_withlog/gpt2
mkdir -p $SAVE
...
export THOUGHT=5
export NUM_ZS=20
export FROM_PRETRAINED=train_models/countdown8/think5/gpt2/checkpoint_3
export ENTROPY_LOSS_LAMBDA=1.0
export SAVE=train_models/countdown8/zs_think${THOUGHT}_zs${NUM_ZS}_lamb${ENTROPY_LOSS_LAMBDA}_withlog/gpt2
mkdir -p $SAVE
